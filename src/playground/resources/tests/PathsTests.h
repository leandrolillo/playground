...
#ifndef SRC_PLAYGROUND_RESOURCES_TESTS_PATHSTESTS_H_
#define SRC_PLAYGROUND_RESOURCES_TESTS_PATHSTESTS_H_
...
#endif /* SRC_PLAYGROUND_RESOURCES_TESTS_PATHSTESTS_H_ */
