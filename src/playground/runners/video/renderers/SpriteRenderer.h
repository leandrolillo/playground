...
protected:
  void doRender(const Camera &camera) override {
    ...
    video.enable(VideoAttribute::DEPTH_TEST); //Defered rendering by texture eliminates ordering thus background is rendered before foreground without depth_test
