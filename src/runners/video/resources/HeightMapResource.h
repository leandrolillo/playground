...
public:
  ...
  virtual String toString() const {
    return String(
        "HeightMap patch [" + std::to_string(this->getWidth()) + "x" + std::to_string(this->getHeight()) + "x"
            + std::to_string(this->getDepth()) + "] based on [ " + std::to_string(this->getGridWidth()) + "x"
            + std::to_string(this->getGridHeight()) + " - voxel size: " + this->voxelSize.toString());
  }
