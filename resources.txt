...
* std::vector<Object> and lambdas: 
    std::vector needs to move/copy objects around as part of its normal element addition operation. This might cause lambdas in the contained objects to get corrupted if they are using [this] reference! Solution: use std::vector<unique_ptr<>> instead or delete copy constructor and equals operator